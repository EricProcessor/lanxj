...
app.controller('mainCtrl', ['$scope', '$rootScope', '$http', '$routeParams', function ($scope, $rootScope, $http, $routeParams) {
    ...
    //用户ID
    // var getUesrId=localStorage.getItem("userid");
    var userid = '1001';
    var userName = "张宇"; //用户名
    //1、搜索框 http
    // 搜索框获得焦点
...
app.controller('sendPostCtrl', ['$scope', '$rootScope', '$http', '$location', '$routeParams', function ($scope, $rootScope, $http, $location, $routeParams) {
    ...
    $scope.sendImg = function (event) {
        ...
        if(imgPage==0){
            addPostInfo(PostContent, topic_id, anonymity_yn, '');
        }else{
            $("#form").ajaxSubmit({
                type: "post",
                ...
                success: function (res) {
                    ...
                    addPostInfo(PostContent, topic_id, anonymity_yn, picUrl);
                },
    ...
    //5. 新增帖子
    // $scope.sendImg = function (event) {
    function addPostInfo(PostContent, topic_id, anonymity_yn, picUrl) {
        console.log(PostContent);
        console.log(topic_id);
        console.log(anonymity_yn);
        var postInfo = {
...
app.controller('plateAngementCtrl', ['$scope', '$rootScope', '$http', '$routeParams', function ($scope, $rootScope, $http, $routeParams) {
    ...
    //1、获取模块数据
    userid = "1001";
    var plateUrl = host + "/attentiontopic/myTopicList";
    $http({
        method: 'post',
        url: plateUrl,
        dataType: "json",
